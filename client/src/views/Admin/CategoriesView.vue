          ...
          <td>
            <i
              ...
              @click="
                idUpdate = el.id;
                nameUpdate = el.name;
                descriptionUpdate = el.description;
              "
              data-bs-toggle="modal"
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form>
              <div class="mb-3">
                <label for="addTitleModalInput" class="form-label">Name</label>
                <input
                  type="text"
                  class="form-control"
              ...
              <div class="mb-3">
                <label for="addTextModalInput" class="form-label"
                  >Description</label
                >
                <input
                  type="text"
            ...
            <form>
              ...
              <div class="mb-3">
                ...
                <input
                  ...
                  v-model.trim="descriptionUpdate"
                />
              </div>
            </form>
          </div>
...
<script src="@/controllers/Admin/CategoriesController.js"></script>